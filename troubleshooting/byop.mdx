...
description: "Learn how to use your existing phone numbers or Twilio account with ClickSpeak.ai through SIP integration or Caller ID verification"
---

## 1. Bring Your Own Number (SIP Integration)

- **Yes**: If you have a PBX or VOIP provider, you can integrate via SIP trunk.
- Inbound & outbound will flow through your existing lines, but still utilize ClickSpeak.ai's AI.
...
- Meanwhile, you can have the best of both worlds by provisioning Twilio-based numbers through ClickSpeak.ai or using a custom approach.
