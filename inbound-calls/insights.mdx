...
After an inbound call, ClickSpeak.ai provides transcripts, analytics, and possible automation triggers.
...
- In your ClickSpeak.ai dashboard, go to **Calls** or **History**.
