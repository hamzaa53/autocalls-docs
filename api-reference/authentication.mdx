...
The ClickSpeak API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your ClickSpeak account at [https://app.clickspeak.ai](https://app.clickspeak.ai)
...
```bash
curl -X GET "https://api.clickspeak.ai/api/user/campaigns" \
