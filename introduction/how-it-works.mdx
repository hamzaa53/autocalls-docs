...
description: "Understand the technical flow of how ClickSpeak.ai processes and handles phone conversations using AI"
---

ClickSpeak.ai blends **AI voice recognition** with **LLM-based replies** to conduct live phone conversations. Below is a simplified flow:

1. **Caller or Lead is Dialed**

   - **Inbound**: A customer dials your assigned phone number.
   - **Outbound**: ClickSpeak.ai's system calls a list of phone numbers from your campaign.

2. **Speech Recognition**  
   The AI listens to what the person says and transcribes it into text in real time.

3. **LLM Decision**  
   ClickSpeak.ai uses a large language model (LLM) and your configured "system prompt" to craft a reply or decide the next action (like transferring the call).
